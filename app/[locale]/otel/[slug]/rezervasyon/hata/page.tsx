...
export default function PaymentErrorPage() {
  ...
  const handleRetry = () => {
    if (paymentData?.hotel?.slug) {
      router.push(withLocale(`/otel/${paymentData.hotel.slug}/odeme`))
    } else {
              ...
              <div className="text-center space-y-6">
                ...
                <div className="bg-white rounded-lg p-6 mt-8">
                  ...
                  <div className="text-left space-y-4">
                    ...
                    <ul className="space-y-2 text-sm text-gray-600 list-disc list-inside">
                      ...
                      <li>{t("reasons.card")}</li>
                      <li>{t("reasons.limit")}</li>
                      <li>{t("reasons.internet")}</li>
                      <li>{t("reasons.bank")}</li>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                  ...
                  {paymentData?.hotel?.slug && (
                    <Link
                      href={withLocale(
                        `/otel/${paymentData.hotel.slug}/rezervasyon?checkin=${paymentData.checkin}&checkout=${paymentData.checkout}&adults=${paymentData.adults}&children=${paymentData.children}`
                      )}
                    >
                      <Button
                        variant="outline"
