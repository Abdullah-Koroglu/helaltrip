...
export default function PaymentSuccessPage() {
  ...
  const getGuestsText = () => {
    ...
    const adults = parseInt(paymentData.adults)
    const children = parseInt(paymentData.children)
    
    if (children > 0) {
      return `${adults} ${t("adults")} ${t("and")} ${children} ${t("children")}`
    }
    
    return `${adults} ${adults > 1 ? t("adults_plural") : t("adults")}`
  }
              ...
              <div className="bg-white rounded-lg p-6 mt-8 space-y-4">
                <div className="text-left space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {paymentData.room && (
                        <>
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-gray-600">{t("mealPlan")}</span>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-semibold">
                          {nights} {nights > 1 ? t("nights_plural") : t("night")}
                        </span>
                      </div>
                      <div className="flex items-center justify-between pt-2 border-t">
                        ...
                        <span className="text-xl font-bold text-green-600">
                          {t("currency")}{paymentData.price.toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t">
                    <h3 className="font-semibold mb-2">{t("guestInfo")}</h3>
