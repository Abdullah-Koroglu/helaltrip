...
const Reviews = () => {
  return (
    ...
    <div className="container mx-auto px-4 mt-12">
      ...
      <h1 className="text-4xl font-bold text-center text-gray-900 mb-4">Yorumlar</h1>
      <p className="text-xl text-center text-gray-600 mb-4">Google'da toplam {review.length} yorum var ve 5/5 puan ortalaması</p>
