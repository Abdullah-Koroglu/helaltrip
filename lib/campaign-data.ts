export const campaigns = [
  {
    ...
    header: 'Erken Rezervasyon Fırsatlarını Kaçırmayın',
  ...
  },
  {
    ...
    description: 'Şah Inn Paradise’te, aqua park eğlencesini ihtişam ve konforla buluşturan özel bir tatil sizi bekliyor. Ailenizle birlikte serinliğin, eğlencenin ve ayrıcalıklı bir atmosferin tadını doyasıya çıkarın.',
